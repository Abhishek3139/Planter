          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="********"
                className="mt-1 block w-full rounded-md border border-green-300 px-3 py-2 pr-10 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
              />
              <button
                type="button"
